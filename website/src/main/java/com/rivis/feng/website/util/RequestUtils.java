...
import com.rivis.feng.website.constants.Constants;
...
//						+":"+request.getServerPort();
	...
	public static String getRequestImagePath(HttpServletRequest request){
		try {
			if(request == null){
				request = ((ServletRequestAttributes)RequestContextHolder.getRequestAttributes())
									.getRequest();
	...
	public static String getRequestPaths(HttpServletRequest request){
		try {
			if(request == null){
				request = ((ServletRequestAttributes)RequestContextHolder.getRequestAttributes())
									.getRequest();
